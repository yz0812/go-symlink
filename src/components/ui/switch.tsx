...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      'peer inline-flex h-6 w-11 shrink-0 cursor-pointer items-center rounded-full border-2 border-transparent transition-colors data-[state=checked]:bg-slate-900 data-[state=unchecked]:bg-slate-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-300 disabled:cursor-not-allowed disabled:opacity-50 dark:data-[state=checked]:bg-slate-100 dark:data-[state=unchecked]:bg-slate-700 dark:focus-visible:ring-slate-700',
      className,
    )}
    {...props}
    ref={ref}
